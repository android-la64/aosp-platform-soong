...
var (
	...
	PlatformArchMap = map[string]string{
		...
		ARCH_LOONGARCH64:   "//build/bazel/platforms/arch:loongarch64",
...
func (attr LabelAttribute) HasConfigurableValues() bool {
	return attr.Arm.Label != "" || attr.Arm64.Label != "" || attr.X86.Label != "" || attr.X86_64.Label != "" || attr.Loongarch64.Label != ""
}
...
func (attrs *LabelListAttribute) archValuePtrs() map[string]*LabelList {
	return map[string]*LabelList{
		...
		ARCH_LOONGARCH64:   &attrs.ArchValues.Loongarch64,
